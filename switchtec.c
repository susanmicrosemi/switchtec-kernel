				 ...
				 struct switchtec_ioctl_flash_part_info __user *uinfo)
{
	...
	case SWITCHTEC_IOCTL_PART_BL2_0:
		info.address = SWITCHTEC_BL2_0_ADDR;
		info.length = SWITCHTEC_BL2_LEN;
		active_flag = ioread32(&fi->active_flag);
		active_bl2_flag = active_flag & SWITCHTEC_BL2_ACT_MASK;
		if (active_bl2_flag == SWITCHTEC_BL2_0_ACTIVE)
			info.active |= SWITCHTEC_IOCTL_PART_ACTIVE;
		if (ioread16(&si->bl2_running) == SWITCHTEC_BL2_0_RUNNING)
			info.active |= SWITCHTEC_IOCTL_PART_RUNNING;
		break;
	case SWITCHTEC_IOCTL_PART_BL2_1:
		info.address = SWITCHTEC_BL2_1_ADDR;
		info.length = SWITCHTEC_BL2_LEN;
		active_flag = ioread32(&fi->active_flag);
		active_bl2_flag = active_flag & SWITCHTEC_BL2_ACT_MASK;
		if (active_bl2_flag == SWITCHTEC_BL2_1_ACTIVE)
			info.active |= SWITCHTEC_IOCTL_PART_ACTIVE;
		if (ioread16(&si->bl2_running) == SWITCHTEC_BL2_1_RUNNING)
			info.active |= SWITCHTEC_IOCTL_PART_RUNNING;
		break;
...
static const struct pci_device_id switchtec_pci_tbl[] = {
	...
	SWITCHTEC_PCI_DEVICE(0x4000),  //PFXI 100XG4
	SWITCHTEC_PCI_DEVICE(0x4084),  //PFXI 84XG4
	SWITCHTEC_PCI_DEVICE(0x4068),  //PFXI 68XG4
	SWITCHTEC_PCI_DEVICE(0x4052),  //PFXI 52XG4
	SWITCHTEC_PCI_DEVICE(0x4036),  //PFXI 36XG4
	SWITCHTEC_PCI_DEVICE(0x4028),  //PFXI 28XG4
	SWITCHTEC_PCI_DEVICE(0x4100),  //PSXI 100XG4
	SWITCHTEC_PCI_DEVICE(0x4184),  //PSXI 84XG4
	SWITCHTEC_PCI_DEVICE(0x4168),  //PSXI 68XG4
	SWITCHTEC_PCI_DEVICE(0x4152),  //PSXI 52XG4
	SWITCHTEC_PCI_DEVICE(0x4136),  //PSXI 36XG4
	SWITCHTEC_PCI_DEVICE(0x4128),  //PSXI 28XG4
	{0}
};
